    ...
    try:
        ...
        with open(output_file, 'w') as file:
            ...
            for _, row in df_sorted.iterrows():
                ...
                # Número do voo original
                numero_voo_original = str(row['Voo']).strip()

                # Ajuste do número do voo para o campo de 8 caracteres
                if numero_voo_original.startswith('Z'):
                    numero_voo = numero_voo_original[1:]  # Remove o 'Z'
                else:
                    numero_voo = numero_voo_original
                ...
                if numero_voo_original.startswith('Z'):
                    numero_voo_display = ' ' + numero_voo_original[1:]
                else:
                    numero_voo_display = numero_voo_original

                # Preencher o número do voo com espaços à direita até 5 caracteres
                numero_voo_display = numero_voo_display.rjust(5)
