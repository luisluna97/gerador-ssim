...
def gerar_ssim(csv_path, codigo_iata, output_file=None):
    try:
        ...
        with open(output_file, 'w') as file:
            ...
            # Inicializar os contadores de voo
            flight_counters = {}
            ...
            for _, row in df.iterrows():
                ...
                # Atualizar o contador para este número de voo
                if numero_voo_padded not in flight_counters:
                    flight_counters[numero_voo_padded] = 1
                else:
                    flight_counters[numero_voo_padded] += 1

                # Obter o valor do contador e formatar com dois dígitos
                flight_counter = str(flight_counters[numero_voo_padded]).zfill(2)

                # Os últimos dois dígitos são sempre "01"
                last_two_digits = "01"

                # Construir o campo de 8 caracteres
                eight_char_field = f"{numero_voo_padded}{flight_counter}{last_two_digits}"
